set moduleName edge_detect_hw_Pipeline_7
set isTopModule 0
...
set cdfgNum 10
set C_modelName {edge_detect_hw_Pipeline_7}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict temp_buf { MEM_WIDTH 32 MEM_SIZE 1048576 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ gmem int 32 regular {axi_master 2}  }
	{ image_gray int 64 regular  }
	{ temp_buf int 32 regular {array 262144 { 1 3 } 1 1 }  }
...
set portList { 
	...
	{ temp_buf_address0 sc_out sc_lv 18 signal 2 } 
	{ temp_buf_ce0 sc_out sc_logic 1 signal 2 } 
	{ temp_buf_q0 sc_in sc_lv 32 signal 2 } 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "262287", "Max" : "262287"}
	, {"Name" : "Interval", "Min" : "262287", "Max" : "262287"}
]}
...
set Spec2ImplPortList { 
	...
	temp_buf { ap_memory {  { temp_buf_address0 mem_address 1 18 }  { temp_buf_ce0 mem_ce 1 1 }  { temp_buf_q0 mem_dout 0 32 } } }
