...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename temp_buf \
    op interface \
    ports { temp_buf_address0 { O 18 vector } temp_buf_ce0 { O 1 bit } temp_buf_we0 { O 1 bit } temp_buf_d0 { O 32 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    id 21 \
    name normal_factor_3_reload \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_normal_factor_3_reload \
    op interface \
    ports { normal_factor_3_reload { I 6 vector } } \
} "
}
...
set InstName edge_detect_hw_flow_control_loop_pipe_sequential_init_U
set CompName edge_detect_hw_flow_control_loop_pipe_sequential_init
set name flow_control_loop_pipe_sequential_init
if {${::AESL::PGuard_autocg_gen} && ${::AESL::PGuard_autocg_ipmgen}} {
if {[info proc ::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control] == "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control"} {
eval "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control { \
    name ${name} \
    prefix edge_detect_hw_ \
}"
} else {
