set moduleName edge_detect_hw_Pipeline_6
set isTopModule 0
...
set cdfgNum 10
set C_modelName {edge_detect_hw_Pipeline_6}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict temp_buf { MEM_WIDTH 32 MEM_SIZE 1048576 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ gmem int 32 regular {axi_master 0}  }
	{ output_r int 64 regular  }
	{ normal_factor_3_reload int 6 regular  }
	{ temp_buf int 32 regular {array 262144 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "image_gray","offset": { "type": "dynamic","port_name": "image_gray","bundle": "control"},"direction": "READWRITE"},{"cName": "output_r","offset": { "type": "dynamic","port_name": "output_r","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "output_r", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "normal_factor_3_reload", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ normal_factor_3_reload sc_in sc_lv 6 signal 2 } 
	{ temp_buf_address0 sc_out sc_lv 18 signal 3 } 
	{ temp_buf_ce0 sc_out sc_logic 1 signal 3 } 
	{ temp_buf_we0 sc_out sc_logic 1 signal 3 } 
	{ temp_buf_d0 sc_out sc_lv 32 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "normal_factor_3_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "normal_factor_3_reload", "role": "default" }} , 
 	{ "name": "temp_buf_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":18, "type": "signal", "bundle":{"name": "temp_buf", "role": "address0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sdiv_32ns_7ns_32_36_1_U18", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2341009", "Max" : "2341009"}
	, {"Name" : "Interval", "Min" : "2341009", "Max" : "2341009"}
]}
...
set Spec2ImplPortList { 
	...
	normal_factor_3_reload { ap_none {  { normal_factor_3_reload in_data 0 6 } } }
	temp_buf { ap_memory {  { temp_buf_address0 mem_address 1 18 }  { temp_buf_ce0 mem_ce 1 1 }  { temp_buf_we0 mem_we 1 1 }  { temp_buf_d0 mem_din 1 32 } } }
}
