...
// wrapc file define:
#define AUTOTB_TVIN_image_gray "../tv/cdatafile/c.edge_detect_hw.autotvin_image_gray.dat"
#define AUTOTB_TVOUT_image_gray "../tv/cdatafile/c.edge_detect_hw.autotvout_image_gray.dat"
#define AUTOTB_TVIN_output_r "../tv/cdatafile/c.edge_detect_hw.autotvin_output_r.dat"
#define AUTOTB_TVOUT_output_r "../tv/cdatafile/c.edge_detect_hw.autotvout_output_r.dat"
#define AUTOTB_TVIN_gmem "../tv/cdatafile/c.edge_detect_hw.autotvin_gmem.dat"
#define AUTOTB_TVOUT_gmem "../tv/cdatafile/c.edge_detect_hw.autotvout_gmem.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_gmem "../tv/rtldatafile/rtl.edge_detect_hw.autotvout_gmem.dat"
...
extern "C"
void edge_detect_hw_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_edge_detect_hw_hw(void* __xlx_apatb_param_image_gray, void* __xlx_apatb_param_output_r)
{
  ...
  port0.param = &__xlx_offset_byte_param_image_gray;
  ...
  port2.param = { __xlx_apatb_param_image_gray, __xlx_apatb_param_output_r };
  port2.mname = { "image_gray", "output_r" };
  port2.nbytes = { 1048576, 1048576 };
  for (size_t off = 0, i = 0; i < port2.nbytes.size(); ++i) {
    port2.offset.push_back(off);
    off += hls::sim::divide_ceil(port2.nbytes[i], port2.asize);
  }
  __xlx_offset_byte_param_image_gray = port2.offset[0]*4;
  ...
  try {
    ...
    edge_detect_hw_hw_stub_wrapper(__xlx_apatb_param_image_gray, __xlx_apatb_param_output_r);
