...
entity edge_detect_hw_control_s_axi is
generic (
...
end entity edge_detect_hw_control_s_axi;
...
architecture behave of edge_detect_hw_control_s_axi is
    ...
    constant ADDR_IMAGE_GRAY_DATA_0 : INTEGER := 16#10#;
    constant ADDR_IMAGE_GRAY_DATA_1 : INTEGER := 16#14#;
    constant ADDR_IMAGE_GRAY_CTRL   : INTEGER := 16#18#;
