...
void cluster_convolve2d_rep2(int input_image[262144], int filter[9], int output_image[262144]);
void convolve2d_rep1(int input_image[262144], int filter[9], int output_image[262144]);
void cluster_convolve2d_rep1(int input_image[262144], int filter[9], int output_image[262144]);
void convolve2d_rep0(int input_image[262144], int filter[9], int output_image[262144]);
void cluster_convolve2d_rep0(int input_image[262144], int filter[9], int output_image[262144]);
...
void edge_detect_sw(int image_rgb[786432], int image_gray[262144], int temp_buf[262144], int filter[9], int output[262144]) {
