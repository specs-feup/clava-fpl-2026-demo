...
#pragma clava begin_outline edge_detect_out0
    filter[0] = 1;
    filter[1] = 2;
    filter[2] = 1;
    filter[3] = 2;
    ...
    filter[7] = 2;
    filter[8] = 1;
#pragma clava end_outline edge_detect_out0
    convolve2d(image_gray, filter, output);
#pragma clava begin_outline edge_detect_out1
    filter[0] = 1;
    filter[1] = 0;
    filter[2] = -1;
    filter[3] = 2;
    ...
    filter[7] = 0;
    filter[8] = -1;
#pragma clava end_outline edge_detect_out1
    convolve2d(output, filter, image_gray);
#pragma clava begin_outline edge_detect_out2
    filter[0] = 1;
    filter[1] = 2;
    filter[2] = 1;
    filter[3] = 0;
    ...
    filter[7] = -2;
    filter[8] = -1;
#pragma clava end_outline edge_detect_out2
