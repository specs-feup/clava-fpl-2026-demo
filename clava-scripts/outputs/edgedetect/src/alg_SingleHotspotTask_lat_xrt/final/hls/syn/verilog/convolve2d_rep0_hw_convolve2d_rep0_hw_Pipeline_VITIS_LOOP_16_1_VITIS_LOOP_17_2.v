...
module convolve2d_rep0_hw_convolve2d_rep0_hw_Pipeline_VITIS_LOOP_16_1_VITIS_LOOP_17_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output  [31:0] normal_factor_1_out;
...
reg   [0:0] icmp_ln16_reg_171;
reg    ap_block_pp0_stage0_11001;
reg   [31:0] gmem_addr_read_reg_175;
reg   [31:0] normal_factor_1_fu_50;
wire   [31:0] normal_factor_fu_136_p2;
wire    ap_block_pp0_stage0_grp0;
wire    ap_loop_init;
reg    ap_loop_exit_ready_pp0_iter1_reg;
reg   [3:0] indvar_flatten_fu_54;
wire   [3:0] add_ln16_fu_99_p2;
reg   [3:0] ap_sig_allocacmp_indvar_flatten_load;
wire    ap_block_pp0_stage0;
wire    ap_block_pp0_stage0_01001_grp0;
wire   [0:0] abscond_fu_124_p2;
wire   [31:0] neg_fu_119_p2;
wire   [31:0] p_d0_0_fu_129_p3;
reg    ap_done_reg;
...
#0 normal_factor_1_fu_50 = 32'd0;
#0 indvar_flatten_fu_54 = 4'd0;
#0 ap_done_reg = 1'b0;
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_exit_ready_pp0_iter1_reg == 1'b1) & (icmp_ln16_reg_171 == 1'd1))) begin
...
assign abscond_fu_124_p2 = (($signed(gmem_addr_read_reg_175) > $signed(32'd0)) ? 1'b1 : 1'b0);

assign add_ln16_fu_99_p2 = (ap_sig_allocacmp_indvar_flatten_load + 4'd1);
...
assign icmp_ln16_fu_93_p2 = ((ap_sig_allocacmp_indvar_flatten_load == 4'd9) ? 1'b1 : 1'b0);
...
assign neg_fu_119_p2 = (32'd0 - gmem_addr_read_reg_175);

assign normal_factor_1_out = normal_factor_1_fu_50;

assign normal_factor_fu_136_p2 = (p_d0_0_fu_129_p3 + normal_factor_1_fu_50);

assign p_d0_0_fu_129_p3 = ((abscond_fu_124_p2[0:0] == 1'b1) ? gmem_addr_read_reg_175 : neg_fu_119_p2);

endmodule //convolve2d_rep0_hw_convolve2d_rep0_hw_Pipeline_VITIS_LOOP_16_1_VITIS_LOOP_17_2
