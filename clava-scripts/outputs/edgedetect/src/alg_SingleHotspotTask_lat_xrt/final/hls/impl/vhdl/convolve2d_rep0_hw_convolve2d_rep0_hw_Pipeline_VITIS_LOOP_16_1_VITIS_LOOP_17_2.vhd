...
entity convolve2d_rep0_hw_convolve2d_rep0_hw_Pipeline_VITIS_LOOP_16_1_VITIS_LOOP_17_2 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of convolve2d_rep0_hw_convolve2d_rep0_hw_Pipeline_VITIS_LOOP_16_1_VITIS_LOOP_17_2 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln16_reg_171 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal gmem_addr_read_reg_175 : STD_LOGIC_VECTOR (31 downto 0);
    signal normal_factor_1_fu_50 : STD_LOGIC_VECTOR (31 downto 0) := "00000000000000000000000000000000";
    signal normal_factor_fu_136_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_pp0_stage0_grp0 : BOOLEAN;
    signal ap_loop_init : STD_LOGIC;
    signal ap_loop_exit_ready_pp0_iter1_reg : STD_LOGIC;
    signal indvar_flatten_fu_54 : STD_LOGIC_VECTOR (3 downto 0) := "0000";
    ...
    signal abscond_fu_124_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal neg_fu_119_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal p_d0_0_fu_129_p3 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln16_fu_93_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    indvar_flatten_fu_54 <= add_ln16_fu_99_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    indvar_flatten_fu_54 <= ap_const_lv4_0;
                end if;
            end if; 
        end if;
    end process;

    normal_factor_1_fu_50_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone_grp0_done_reg) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001_grp0))) then
                if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
                    normal_factor_1_fu_50 <= ap_const_lv32_0;
                elsif ((ap_enable_reg_pp0_iter2 = ap_const_logic_1)) then 
                    normal_factor_1_fu_50 <= normal_factor_fu_136_p2;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                icmp_ln16_reg_171 <= icmp_ln16_fu_93_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001_grp1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                gmem_addr_read_reg_175 <= m_axi_gmem_0_RDATA;
            end if;
        end if;
    end process;
    ...
    abscond_fu_124_p2 <= "1" when (signed(gmem_addr_read_reg_175) > signed(ap_const_lv32_0)) else "0";
    add_ln16_fu_99_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_indvar_flatten_load) + unsigned(ap_const_lv4_1));
    ...
    ap_sig_allocacmp_indvar_flatten_load_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_loop_init, indvar_flatten_fu_54, ap_block_pp0_stage0)
    begin
    ...
    icmp_ln16_fu_93_p2 <= "1" when (ap_sig_allocacmp_indvar_flatten_load = ap_const_lv4_9) else "0";
    ...
    neg_fu_119_p2 <= std_logic_vector(unsigned(ap_const_lv32_0) - unsigned(gmem_addr_read_reg_175));
    normal_factor_1_out <= normal_factor_1_fu_50;

    normal_factor_1_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_11001_grp0, ap_block_pp0_stage0_subdone_grp0_done_reg, icmp_ln16_reg_171, ap_loop_exit_ready_pp0_iter1_reg)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone_grp0_done_reg) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001_grp0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_exit_ready_pp0_iter1_reg = ap_const_logic_1) and (icmp_ln16_reg_171 = ap_const_lv1_1))) then 
    ...
    normal_factor_fu_136_p2 <= std_logic_vector(unsigned(p_d0_0_fu_129_p3) + unsigned(normal_factor_1_fu_50));
    p_d0_0_fu_129_p3 <= 
        gmem_addr_read_reg_175 when (abscond_fu_124_p2(0) = '1') else 
        neg_fu_119_p2;
end behav;
